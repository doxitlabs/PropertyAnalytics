...
$publishDir = "\\DOXITLABSSERVER\inetpub\wwwroot\PropertyAnalyticsWS"
...
Invoke-Command -ComputerName DOXITLABSSERVER -ScriptBlock { net stop W3SVC /y }
...
Invoke-Command -ComputerName DOXITLABSSERVER -ScriptBlock { net start W3SVC }
